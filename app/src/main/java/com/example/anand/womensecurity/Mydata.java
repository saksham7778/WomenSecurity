...
public class Mydata {
    ...
    {
        final String SERVER_URL = "http://192.168.43.97:80/ws/signup.php"; // The server(Servlet) which will process the request. Note 10.0.2.2 is the localhost IP for emulator
    ...
    {
        final String SERVER_URL = "http://192.168.43.97:80/ws/login.php"; // The server(Servlet) which will process the request. Note 10.0.2.2 is the localhost IP for emulator
        final String CHAR_SET = "UTF-8"; // Encoding used for the parameters
        OutputStream output = null;
        String response = "";
        try
...
//          Toast.makeText(null,e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    {
        final String SERVER_URL = "http://192.168.43.97:80/ws/savedangerlocation.php"; // The server(Servlet) which will process the request. Note 10.0.2.2 is the localhost IP for emulator
        final String CHAR_SET = "UTF-8"; // Encoding used for the parameters
        OutputStream output = null;
        String response = "";
        try
...
///         Toast.makeText(null,e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    {
        final String SERVER_URL = "http://192.168.43.97:80/ws/savecontact.php"; // The server(Servlet) which will process the request. Note 10.0.2.2 is the localhost IP for emulator
        final String CHAR_SET = "UTF-8"; // Encoding used for the parameters
        OutputStream output = null;
        String response = "";
        try
...
///         Toast.makeText(null,e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    {
        final String SERVER_URL = "http://192.168.43.97:80/ws/recpno.php"; // The server(Servlet) which will process the request. Note 10.0.2.2 is the localhost IP for emulator
        final String CHAR_SET = "UTF-8"; // Encoding used for the parameters
        OutputStream output = null;
        String response = "";
        try
...
///         Toast.makeText(null,e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    {
        final String SERVER_URL = "http://192.168.43.97:80/ws/reclat.php"; // The server(Servlet) which will process the request. Note 10.0.2.2 is the localhost IP for emulator
        final String CHAR_SET = "UTF-8"; // Encoding used for the parameters
        OutputStream output = null;
        String response = "";
        try {
...
//            Toast.makeText(null,ex.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    {
        final String SERVER_URL = "http://192.168.43.97:80/ws/reclon.php"; // The server(Servlet) which will process the request. Note 10.0.2.2 is the localhost IP for emulator
        final String CHAR_SET = "UTF-8"; // Encoding used for the parameters
        OutputStream output = null;
        String response = "";
        try {
...
//            Toast.makeText(null,ex.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    {
        final String SERVER_URL = "http://192.168.43.97:80/ws/addpolicestation.php"; // The server(Servlet) which will process the request. Note 10.0.2.2 is the localhost IP for emulator
        final String CHAR_SET = "UTF-8"; // Encoding used for the parameters
        OutputStream output = null;
        String response = "";
        try
...
///         Toast.makeText(null,e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public static String recpolat(){
        final String SERVER_URL = "http://192.168.43.97:80/ws/recpolat.php"; // The server(Servlet) which will process the request. Note 10.0.2.2 is the localhost IP for emulator
        final String CHAR_SET = "UTF-8"; // Encoding used for the parameters
        OutputStream output = null;
        String response = "";
        try {
...
//            Toast.makeText(null,ex.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public static String recpolon(){
        final String SERVER_URL = "http://192.168.43.97:80/ws/recpolon.php"; // The server(Servlet) which will process the request. Note 10.0.2.2 is the localhost IP for emulator
        final String CHAR_SET = "UTF-8"; // Encoding used for the parameters
        OutputStream output = null;
        String response = "";
        try {
...
//            Toast.makeText(null,ex.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public static String recpolicepno(){
        final String SERVER_URL = "http://192.168.43.97:80/ws/recpolicepno.php"; // The server(Servlet) which will process the request. Note 10.0.2.2 is the localhost IP for emulator
        final String CHAR_SET = "UTF-8"; // Encoding used for the parameters
        OutputStream output = null;
        String response = "";
        try {
...
//            Toast.makeText(null,ex.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public static String adddangerlocation(String latitude,String longtitude,String name){
        final String SERVER_URL = "http://192.168.43.97:80/ws/adddangerlocation.php"; // The server(Servlet) which will process the request. Note 10.0.2.2 is the localhost IP for emulator
        final String CHAR_SET = "UTF-8"; // Encoding used for the parameters
        OutputStream output = null;
        String response = "";
